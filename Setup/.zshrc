...
fastfetch --logo "/home/sapien/.config/fastfetch/termascii.txt" --logo-color-1 36 --color-keys magenta --title-color-user magenta --title-color-host magenta --logo-padding-top 2 --logo-padding-right 2 --logo-padding-left 2 --separator-length 62
